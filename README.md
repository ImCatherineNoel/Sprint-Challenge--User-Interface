...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    Its HTML that is describeS what it is or why it there. 
...
4. Explain why git is valuable to a team of developers.
    It allows many people to work on the same basic project. It also tracks what and when every person has contributed so that if/when a project breaks it can be "rolled back" the issues fixed then implemented again.
